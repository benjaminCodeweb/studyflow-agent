...
export async function startAgent(ctx) {
    const room = ctx.room;
            ...
            bufferTimer = setTimeout(async () => {
                ...
                try {
                    ...
                    if (room.localParticipant) {
                        room.localParticipant.publishData(new TextEncoder().encode(transcript.text || ""), { reliable: true });
                    }
                    else {
...
function pcm16ToWav(pcm, sampleRate = 48000) {
